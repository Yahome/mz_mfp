...
export function useRecordLogic(opts: { patientNo: string; form: FormInstance<BaseInfoFormValues> }) {
  ...
  const feeSummary = useMemo(() => {
    ...
    return {
      ...
      hlf: asString(getPrefillValue("HLF")),
      qtfy: asString(getPrefillValue("QTFY")),
      blzdf: asString(getPrefillValue("BLZDF")),
      zdf: asString(getPrefillValue("ZDF")),
      yxxzdf: asString(getPrefillValue("YXXZDF")),
      lczdxmf: asString(getPrefillValue("LCZDXMF")),
      fsszlxmf: asString(getPrefillValue("FSSZLXMF")),
      zlf: asString(getPrefillValue("ZLF")),
      sszlf: asString(getPrefillValue("SSZLF")),
      mzf: asString(getPrefillValue("MZF")),
      ssf: asString(getPrefillValue("SSF")),
      kff: asString(getPrefillValue("KFF")),
      zyl_zyzd: asString(getPrefillValue("ZYL_ZYZD")),
      zyzl: asString(getPrefillValue("ZYZL")),
      zywz: asString(getPrefillValue("ZYWZ")),
      zygs: asString(getPrefillValue("ZYGS")),
      zcyjf: asString(getPrefillValue("ZCYJF")),
      zytnzl: asString(getPrefillValue("ZYTNZL")),
      zygczl: asString(getPrefillValue("ZYGCZL")),
      zytszl: asString(getPrefillValue("ZYTSZL")),
      zyqt: asString(getPrefillValue("ZYQT")),
      zytstpjg: asString(getPrefillValue("ZYTSTPJG")),
      bzss: asString(getPrefillValue("BZSS")),
      xyf: asString(getPrefillValue("XYF")),
      kjywf: asString(getPrefillValue("KJYWF")),
      zcyf: asString(getPrefillValue("ZCYF")),
      zyzjf: asString(getPrefillValue("ZYZJF")),
      zcyf1: asString(getPrefillValue("ZCYF1")),
      pfklf: asString(getPrefillValue("PFKLF")),
      xf: asString(getPrefillValue("XF")),
      bdbblzpf: asString(getPrefillValue("BDBBLZPF")),
      qdbblzpf: asString(getPrefillValue("QDBBLZPF")),
      nxyzlzpf: asString(getPrefillValue("NXYZLZPF")),
      xbyzlzpf: asString(getPrefillValue("XBYZLZPF")),
      jcyyclf: asString(getPrefillValue("JCYYCLF")),
      yyclf: asString(getPrefillValue("YYCLF")),
      ssycxclf: asString(getPrefillValue("SSYCXCLF")),
      qtf: asString(getPrefillValue("QTF")),
    };
