...
export default function BaseInfoSection({ prefillMeta }: Props) {
  ...
  return (
    <Space direction="vertical" size="middle" style={{ width: "100%" }}>
      {/* 身份与证件 */}
      <BoardingPassCard title="身份与证件" variant="primary">
      ...
      {/* 过敏史 */}
      <BoardingPassCard title="过敏史" variant="warning">
        <div style={{ background: "#FFFFFF", borderRadius: "8px", padding: "16px" }}>
          <Row gutter={16}>
            <Col span={8}>
              <Form.Item
      ...
      {/* 就诊信息 */}
      <BoardingPassCard title="就诊信息" variant="success">
        <div style={{ background: "#FFFFFF", borderRadius: "8px", padding: "16px" }}>
          <Row gutter={16}>
            <Col span={8}>
              <Form.Item
      ...
      {/* 急诊信息 */}
      <BoardingPassCard title="急诊信息" variant="secondary">
        <div style={{ background: "#FFFFFF", borderRadius: "8px", padding: "16px" }}>
          <Row gutter={16}>
            <Col span={8}>
              <Form.Item
      ...
      {/* 主诉 */}
      <BoardingPassCard title="主诉" variant="primary">
        <div style={{ background: "#FFFFFF", borderRadius: "8px", padding: "16px" }}>
          <Row gutter={16}>
            <Col span={24}>
